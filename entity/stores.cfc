<cfcomponent persistent="true" entityname="stores" table="stores" >
   ...
   <cfproperty name="userlist" fieldtype="one-to-many" cfc="userlist" fkcolumn="storeid">
   ...
   <cfproperty name="eroeslogin" fieldtype="one-to-many" cfc="eroeslogin" fkcolumn="storeid">
   <cfproperty name="eroesid">
   <cfproperty name="MERCHANTID">
   </cfcomponent>